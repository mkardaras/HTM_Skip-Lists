...
for i in "${num_procs[@]}"    
do
    skip1[$i]=`$bin1  -i $i_s -r $range -u $u_r -d 1000 -n $i -s 60| grep $var | grep '(?<= )[0-9]+\.?[0-9]+' -Po`
    skip2[$i]=`$bin2  -i $i_s -r $range -u $u_r -d 1000 -n $i -s 60| grep $var | grep '(?<= )[0-9]+\.?[0-9]+' -Po`
    skip3[$i]=`$bin3  -i $i_s -r $range -u $u_r -d 1000 -n $i -s 60| grep $var | grep '(?<= )[0-9]+\.?[0-9]+' -Po`
    skip4[$i]=`$bin4  -i $i_s -r $range -u $u_r -d 1000 -n $i -f 15 -x 30| grep $var | grep '(?<= )[0-9]+\.?[0-9]+' -Po`
	skip5[$i]=`$bin4  -i $i_s -r $range -u $u_r -d 1000 -n $i -f 15 -x 30 -c| grep $var | grep '(?<= )[0-9]+\.?[0-9]+' -Po`
